...
export const sidebarApps = [
	{
		_id: 'alerts',
		href: getAppBaseUrl('alerts', process.env.ENVIRONMENT),
	...
	{
		_id: 'auth',
		href: getAppBaseUrl('auth', process.env.ENVIRONMENT),
	...
	{
		_id: 'controller',
		href: getAppBaseUrl('controller', process.env.ENVIRONMENT),
	...
	{
		_id: 'equipments',
		href: getAppBaseUrl('equipments', process.env.ENVIRONMENT),
	...
	{
		_id: 'stops',
		href: getAppBaseUrl('stops', process.env.ENVIRONMENT),
	...
	{
		_id: 'plans',
		href: `${getAppBaseUrl('plans', process.env.ENVIRONMENT)}/plans`,
	...
	{
		_id: 'validations',
		href: `${getAppBaseUrl('plans', process.env.ENVIRONMENT)}/validations`,
